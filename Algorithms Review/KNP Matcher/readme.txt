...
*Note provide doesn't allow files as large as the medium and large text files but they
*can easily be created by concatinating small with itself an appropriate amount of times.
*If you'd like to avoid that just send me an e-mail and we'll figure out how to get
*medium.txt and large.txt from my account to the provide drop box.
